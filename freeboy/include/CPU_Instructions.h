...
namespace gameboy::instruction
{
    ...
    struct Info
    {
        ...
        void (CPU_Processes::*addrFunction)();
    ...
    static constexpr std::array<Info, 0x100> STANDARD_INSTRUCTIONS
            {
                    // 0x0
                    Info{1, 1, &CPU_Processes::NOP, InstructionType::NOP, AddressMode::IMP}, // 0x00
                    Info{},
                    Info{},
                    Info{},
                    Info{},
                    Info{1, 1, &CPU_Processes::DEC, InstructionType::DEC, AddressMode::R, RegisterType::B}, // 0x05
                    Info{},
                    Info{},
                    Info{},
                    Info{},
                    ...
                    Info{},
                    Info{},
                    Info{2, 2, &CPU_Processes::LD, InstructionType::LD, AddressMode::R_D8, RegisterType::C}, // 0x0E
                    Info{},
                    ...
                    Info{},
                    Info{},
                    Info{1, 1, &CPU_Processes::XOR, InstructionType::XOR, AddressMode::R, RegisterType::A}, // 0xAF
                    ...
                    Info{},
                    Info{},
                    Info{3, 4, &CPU_Processes::JP, InstructionType::JP, AddressMode::D16}, // 0xC3
                    Info{},
                    Info{},
                    Info{},
                    Info{},
